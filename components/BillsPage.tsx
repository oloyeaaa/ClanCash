    ...
    <div className="max-w-4xl mx-auto px-6 py-4 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10">
        <div>
          ...
          <p className="text-emerald-500/60 font-medium">All household bills and reminders</p>
        </div>
              ...
              <div className={`w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] glass p-6 rounded-3xl transition-all duration-500 ${dueSoon ? 'ring-2 ring-red-500/30 shadow-[0_0_30px_rgba(239,68,68,0.2)]' : 'hover:bg-white/10'}`}>
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-500/60">{item.category}</p>
                  </div>
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-white/5">
                  ...
                  <span className="text-[9px] font-black uppercase tracking-widest text-white/30">Requested by {item.creatorName}</span>
                  {dueSoon && (
